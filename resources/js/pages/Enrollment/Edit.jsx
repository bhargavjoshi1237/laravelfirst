...
export default function Edit() {
    const { enrollment, students, batches } = usePage().props;
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                <h1 className="text-2xl font-bold mb-6 text-gray-800">Edit Enrollment</h1>
                <form>
                    <div className="mb-4">
                    ...
                    <button
                        type="button"
                        disabled={processing}
                        onClick={() => put(route('enrollment.update', enrollment.id))}
